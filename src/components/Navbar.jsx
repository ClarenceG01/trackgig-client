...
export default function Navbar() {
  ...
  return (
    <div className=" py-2 flex justify-between items-center relative ">
      ...
      <ul className="hidden md:flex gap-6 font-[var(--font-inter)] text-light-text text-lg">
      ...
      <div className="hidden md:flex gap-4">
        <button className="rounded-[10px] border-2 border-green text-light-text px-4 py-1.5 hover:bg-green hover:text-white transition-colors duration-300 cursor-pointer">
          Login
        </button>
        <button className="rounded-[10px] bg-green text-white px-4 py-1.5 hover:border-2 hover:border-green hover:bg-transparent hover:text-light-text transition-colors duration-300 hover:px-3.5 hover:py-1">
          Sign up
        </button>
      </div>
